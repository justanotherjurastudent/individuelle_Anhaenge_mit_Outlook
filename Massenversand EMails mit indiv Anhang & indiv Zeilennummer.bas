...
With fd
    ...
    If .Show = -1 Then
        ...
        Anfangszeile = InputBox("Geben Sie die Zeilennummer an, ab welcher die Datensätze enthalten sind:")
        ...
        msg = "Folgende Datengruppen wurden gefunden:" & vbNewLine & _
          ...
          "Anfangszeile: " & Anfangszeile & vbNewLine & vbNewLine & _
          "Sind Sie mit den ausgewählten Spalten und der Anfangszeile einverstanden?"
        Einverstanden = MsgBox(msg, vbQuestion + vbYesNoCancel, "Spalten der Datengruppen und Anfangszeile")
        ...
        Select Case Datengruppe
            ...
            Case "Anfangszeile"
                Anfangszeile = InputBox("Bitte geben Sie die korrekte Anfangszeile ein:")
            End Select
		...
		For i = Anfangszeile To lastRow ' Schleife von Zeile 2 bis zur letzten Zeile
        ...
        strAttach = xlWS.Range(SpalteAttach & i).Value ' Wert in der Spalte mit den Anhängen, aktuelle Zeile
         ...
         ' Überprüfe, ob die Anrede für jenes Geschlecht stimmt
        If strAnrede = "Frau" Then
            strAnrede = "Sehr geehrte Frau"
        ElseIf strAnrede = "Herr" Then
            strAnrede = "Sehr geehrter Herr"
        Else
            strAnrede = "" ' set an empty string if the value is neither "Frau" nor "Herr"
        End If
