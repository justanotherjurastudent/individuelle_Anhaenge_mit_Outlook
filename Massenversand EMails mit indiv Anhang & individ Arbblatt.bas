...
With fd
    ...
    If .Show = -1 Then
        ...
        'Es folgt ein Dialog, in der das Arbeitsblatt ausgewählt werden muss
        Dim sheetList As String

        For c = 1 To xlWB.Sheets.Count
        sheetList = sheetList & Worksheets(c).Name & ", "
        Next c
        
        sheetName = InputBox("Bitte wählen Sie ein Blatt aus, indem Sie nur noch den richtigen Arbeitsblattnamen in der Box übrig lassen:", "Blatt auswählen", sheetList)
